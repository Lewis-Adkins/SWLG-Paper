...
We do ten randomized 80/20 splits of  our raw particle intensity data into training and test sets chronologically respectively. Each dataset runs 10 models with each seed totaling 100 models for one forecasting time \cite{pastore2021extrapolating} . One of the datasets is the original chronological split that Torres uses where there is 21 SEP identified events in the training set and 18 SEP events in the test set. \citet[Table-1]{torres2025machine}. 
